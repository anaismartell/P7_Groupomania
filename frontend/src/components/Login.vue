        ...
        <v-card raised>
            <v-card-text>
                <v-form ref="form" v-model="valid">
                    ...
                    <v-text-field v-model="dataLogin.password" :rules="passwordRules" type="password" label="Mot de passe" prepend-icon="mdi-lock-outline" color="black" required></v-text-field>
                </v-form>
            </v-card-text>
