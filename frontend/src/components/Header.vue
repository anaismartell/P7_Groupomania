<template>
    <div class="head">
        <v-navigation-drawer v-model="drawer" color="black" expand-on-hover mini-variant mini-variant-width=45 bottom permanent absolute dark>
            <v-list dense nav>
                <v-list-item two-line class="px-0 ">
                    <v-list-item-avatar>
                        <v-img src="../assets/icon-left-font-monochrome-black.png" contain></v-img>
                    </v-list-item-avatar>
             </v-list-item>
